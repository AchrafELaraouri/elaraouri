...
// Fonction pour afficher ou masquer l'icône qui suit les mouvements en fonction de l'état du menu, uniquement sur les téléphones
function toggleFollowIcon() {
    if (isMobile()) {
        ...
        if (navbarToggler.getAttribute('aria-expanded') === 'true') {
            followIcon.classList.add('menu-open');
            followIcon.innerHTML = ''; // Vider le contenu de l'icône
        } else {
            followIcon.classList.remove('menu-open');
            followIcon.innerHTML = 'Menu'; // Remettre le texte "Menu" dans l'icône
        }
    }
}

// Fonction pour mettre à jour la position de l'icône de menu en fonction de la position de défilement
...
// Ajoutez un écouteur d'événements pour mettre à jour la position de l'icône lorsque la page est défilée, uniquement sur les téléphones
